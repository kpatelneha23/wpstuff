...
define( 'DB_CREDENTIALS_PATH', dirname( __FILE__ ) . '/wp-config'); // cache it for multiple use
...
if ( file_exists( DB_CREDENTIALS_PATH . '/maintenance-on.php' ) ) {
    if ( $_SERVER['REMOTE_ADDR'] != "70.80.141.25" ) {
        require_once( DB_CREDENTIALS_PATH . '/maintenance-on.php' );
        die();
    }
}
